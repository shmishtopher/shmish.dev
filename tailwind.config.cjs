      ...
      typography: ({ theme }) => ({
        DEFAULT: {
          css: {
            ...
            a: { fontFamily: theme("fontFamily.mona").join(",") },
            strong: { fontFamily: theme("fontFamily.mona").join(",") },
            figcaption: { fontFamily: theme("fontFamily.mona").join(",") },
            code: { fontFamily: "monospace" },
            th: {  fontFamily: theme("fontFamily.hubot").join(",")  },
            td: { fontFamily: theme("fontFamily.mona").join(",") },
            blockquote: { fontFamily: theme("fontFamily.hubot").join(",") },
          }
        }
      })
    }
